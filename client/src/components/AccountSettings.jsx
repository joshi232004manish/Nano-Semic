    ...
    <div className="p-6">
      ...
      <div className="border p-5 rounded-md mb-6 flex justify-between items-start">
        <div>
          ...
          <p><span className="font-bold">Last Name:</span> Joshi</p>
          <p><span className="font-bold">First Name:</span> Manish</p>
          <p><span className="font-bold">Phone:</span> +918791852055</p>
        </div>
